...
If ((Get-Content "$($env:windir)\system32\Drivers\etc\services" ) -notcontains "sapmsETA 3610/tcp")  
 {Add-Content -Encoding UTF8  "$($env:windir)\system32\Drivers\etc\services" "sapmsETA 3610/tcp" }