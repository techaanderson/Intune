...
#$ProgramExe = "DesktopInfo.exe"
#$ProgramPath = "$Env:Programfiles\$ProgramName\$ProgramExe"
...
$Version = "1"
$ProgramVersion_current = Get-Content -Path "$Env:Programfiles\_MEM\Validation\$PackageName"
...
New-Item -Path "$Env:Programfiles\_MEM\Validation\$PackageName" -ItemType "file" -Force -Value $Version
